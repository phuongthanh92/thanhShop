...
namespace HoangVN\Payment\NganLuong;
...
//lớp client mức độ cao
    ...
    */
    ...
    //DienDC them vao ngay 16/02/2009
    // cho phep tu dinh nghia Encoding Style
    function setSoapDefEncoding($encoding_style)
    {
        $this->soap_defencoding = $encoding_style;
    }

    function getSingleItemResults($ItemID)
    {
        ...
        // Construct the FindItems REST call
        $apicall = "$endpoint?callname=GetSingleItem&version=537"
            . "&appid=PeaceSof-11ab-47c4-965e-23984def9fd8&ItemID=$ItemID"
