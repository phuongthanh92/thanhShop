...
<div class="span12">
    <div class="well form-inline">
        <div class="span6">
            ...
            <input type="text" name="name" id="group_name" value="{{ $group->group_name }}">
            <a href="javascript: void(0)" id="add_group" data-url="{{ action('AdminAttGroupController@postEdit') }}/{{ $group->_id }}" class="btn">Cập nhật</a>
...
<div class="span12">
    <div class="span5">
        ...
        <ul id="sortable1" class="droptrue span10">
            ...
            @if(in_array($val->code,$group->group_attributes))
