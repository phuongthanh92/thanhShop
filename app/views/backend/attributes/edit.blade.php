...
@stop
@section('content')
<h3 class="heading">Cập nhật thuộc tính</h3>
<div class="span8">
    {{ Form::model($attribute, array('action' => array('AdminAttributeController@postUpdate', $attribute->_id),'id'=>'form_validation_ttip','class'=>'form_validation_ttip')) }}
    <div class="formRow">
        <div class="row-fluid">
            <div class="span12">
        ...
        <div class="row-fluid">
            <div class="span12">
                ...
                {{ FORM::text('code', null, array('class'=>'span8')) }}
        ...
        <div class="row-fluid">
            <div class="span12">
                ...
                {{ FORM::text('value', null, array('class'=>'span8')) }}
            </div>
        </div>
        <div class="row-fluid">
            <div class="span12">
            ...
            <div class="span12">
                <div class="span12 label-data" id="type-data" style="@if(!isset($attribute->data) && count($attribute->data)==0)display: none @endif">
                    <div class="row-fluid">
                    ...
                    @foreach($attribute->data as $key => $val)
                    <div class="row-fluid" id="type-data-item" style="display: none">
                        <div class="span12">
                            <div class="span4">
                                <p>
                                    <input class="span10 type_data" placeholder="Giá trị" type="text" value="{{ $key }}">
                                </p>
                            </div>
                            <div class="span7">
                                <p>
                                    <input class="span10 type_label" placeholder="Nhãn" type="text" value="{{ $val }}">
                                </p>
                            </div>
                            <div class="remove-data span1" title="Xoá" style="cursor: pointer"><i class="splashy-remove "></i></div>
                        </div>
            ...
            <div class="row-fluid">
                <div class="span12">
                    ...
                    <label class="radio">{{ Form::radio('require', '1') }} Có</label>
