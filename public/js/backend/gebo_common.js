...
//				$('input[name=ssw_sidebar]:first,input[name=ssw_layout]:first,input[name=ssw_menu]:first').attr('checked', true);
            ...
            $('.style_switcher .jQclr').click(function (){
                ...
                $('#link_theme').attr('href', baseUrl + 'public/css/backend/' + style_selected + '.css');
                $.localStorage.set('optionColors', style_selected);
            });
            ...
            $('.style_switcher .jQptrn').click(function (){
                ...
                if($(this).hasClass('jQptrn')){
                    ...
                    $.localStorage.set('optionBackgrounds', style_selected);
                }
                ;
            });
            //* layout
            $('input[name=ssw_layout]').click(function (){
                ...
                $.localStorage.set('optionLayout', layout_selected);
            });
            //* sidebar position
            $('input[name=ssw_sidebar]').click(function (){
                ...
                $(window).resize();
                $.localStorage.set('optionSidebar', sidebar_position);
            });
            //* menu show
            $('input[name=ssw_menu]').click(function (){
                var menu_show = $(this).val();
                $('body').removeClass('ssw_menu_click').addClass(menu_show);
                $.localStorage.set('optionMenuShow', menu_show);
            });

            //* reset
            $('#resetDefault').click(function (){
                $('body').attr('class', 'menu_hover');
            ...
            /*				$('#showCss').on('click',function(e){
             ...
             if( (themeLink != 'public/backend/css/blue.css') && (themeLink != undefined) ) {
    ...
    removeOption: function (){
        $.localStorage.remove('optionBackgrounds');
        $.localStorage.remove('optionColors');
        $.localStorage.remove('optionLayout');
        $.localStorage.remove('optionSidebar');
        $.localStorage.remove('optionMenuShow');
    }
};